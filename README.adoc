...
[source]
----
startserver [-hvcLOMmfsn] [--ha] [--file=<file>] <serverDir>
----
...
[source,bash]
----
$ jbang maven-dep-graph@jdlee -a org.junit.jupiter:junit-jupiter:6.1.0 | dot -Tpng -o junit-dep-graph.png
----
...
[source]
----
base64 [-hvde] [-o=<outputFile>] <fileName>
----
